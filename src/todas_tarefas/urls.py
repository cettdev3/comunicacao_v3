...
from todas_tarefas.views import Todas_Tarefas,Get_Users_Designante,Get_Peca_Filter,Get_Modal_task,Jobs_Individual,Get_Pecas,Get_Pecas_Individual,All_Jobs

urlpatterns = [
    path('all-demands',  Todas_Tarefas),
