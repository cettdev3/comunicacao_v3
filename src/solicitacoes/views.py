...
def Solicitacao(request):
    ...
    foto = Perfil.objects.filter(user_profile=request.user).first()
    return render(request,'solicitacoes.html',{'paginas':page,'solicitacoes':solicitacoes,'perfil':perfil,'foto':foto})
